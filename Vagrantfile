...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "data" do |data|
    ...
    data.vm.box_check_update = false
    data.vm.network "private_network", ip: "172.16.0.2"
    data.vm.hostname = "data"  
    data.vm.provider "virtualbox" do |vb|
       vb.memory = "512"
    end
    config.vm.provision "shell", path: "bash_scripts/data.sh"
  end
  ...
  config.vm.define "web" do |web|                  
    ...
    config.vm.provision "shell", path: "bash_scripts/web.sh"
  end
